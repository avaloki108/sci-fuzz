...
//! This lets us track: which bugs chimerafuzz finds, which it misses, and how
//! long each takes.
...
/// Total entries in [`benchmark_matrix`].
pub fn benchmark_matrix_len() -> usize {
    benchmark_matrix().len()
}
